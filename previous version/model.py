...
class LSTM(nn.Module):
    def __init__(self, lstm_input_size=1, hidden_layer_size = lstm_hidden_layer_size):
        super(LSTM, self).__init__()
        self.hidden_layer_size = hidden_layer_size
        # The input and output tensor provided to the model will have the format like 'shape(batch, seq, feature)'
        self.lstm = nn.LSTM(lstm_input_size, self.hidden_layer_size, num_layers=2, batch_first=True, dropout=dropout)
