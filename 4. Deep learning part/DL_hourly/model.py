...
class LSTM(nn.Module):
    def __init__(self, input_size, hidden_layer_size, dropout):
        super(LSTM, self).__init__()

        self.hidden_layer_size = hidden_layer_size
        self.lstm = nn.LSTM(input_size, hidden_layer_size, num_layers=2, batch_first=True, dropout=dropout)
...
class LSTMWithMLP(nn.Module):
    ...
    def __init__(self, lstm_input_size, output_size, num_gaussians, mlp_input_dim, lstm_hidden_layer_size, mlp_hidden_dim, dropout): 
        super(LSTMWithMLP, self).__init__()

        self.lstm = LSTM(input_size=lstm_input_size, hidden_layer_size=lstm_hidden_layer_size, dropout=dropout)
        ...
        self.mdn = MDNLayer(lstm_hidden_layer_size * 2, output_size, num_gaussians)
